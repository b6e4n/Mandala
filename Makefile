...
# Project:  Mandala.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake CONFIG+=c++11 -o Makefile Mandala.pro
#############################################################################
...
SOURCES       = main.cpp \
		MainWindow.cpp \
		PaintArea.cpp moc_MainWindow.cpp
OBJECTS       = main.o \
		MainWindow.o \
		PaintArea.o \
		moc_MainWindow.o
...
Makefile: Mandala.pro /usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64/qmake.conf /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) CONFIG+=c++11 -o Makefile Mandala.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents MainWindow.h PaintArea.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp MainWindow.cpp PaintArea.cpp $(DISTDIR)/
